...
<form method="POST" action="resto_add2.php" enctype="multipart/form-data">
  	...
  	<div>
        <br>
        <button type="submit" class = "btn btn-success" name="Resto"> POST </button>
