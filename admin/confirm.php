  ...
  <?php  
        ...
        {  
              ...
              <tr>  
                  ...
                  <a href="checkin_delete.php?del='.$row['guest_id'].'"><button type="button" class=" btn btn-danger"><i class="fa fa-trash-o" style="font-size:15px"></i></button></a>
                  <a href="checkin_confirm.php?confirm='.$row['guest_id'].'"><button type="button" class=" btn btn-success"><i class="fa fa-check" style="font-size:15px"></i></button></a>
              </tr>  
