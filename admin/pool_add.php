...
<div class="home-content card-body">
          ...
          <div class="recent-booking box">
            <div class="title"></div>
            <br>
            <button data-id = "<?php echo $row['id']; ?>" class="addroom btn btn-warning"> <i class='fas fa-umbrella-beach'></i> Add Photos in Pool </button>
  ...
  <?php  
        ...
        {  
              ...
              <tr>  
                  ...
                  <td><img src="../Gallery/'.$row["pool"].'" width="200" height="200"></td>  
                  <td>
                  <a href="pool_delete.php?del='.$row['id'].'"><button type="button" class=" btn btn-danger"><i class="fa fa-trash" style="font-size:30px"></i></button></a>     
              </tr>  
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Add photos in Pool</h4>
