...
$id = $_GET['confirm'];
$confirm = "INSERT INTO records SELECT * FROM check_in where guest_id = '$id'";
$results1 = mysqli_query($data, $confirm);

if($results1){
  $sql = "DELETE FROM check_in WHERE guest_id = '$id'";
  ...
  $info = " The guest ($guest_id) goes to record by ($user_log)";
 ...
 $_SESSION['status'] = "GOES TO RECORDS";
