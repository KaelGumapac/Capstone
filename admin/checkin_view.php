...
$userid = $_POST['userid'];
$sql = "select * from check_in where id=".$userid;
$result = mysqli_query($data,$sql);
while( $row = mysqli_fetch_assoc($result) ){
?>

 <?php $_SESSION['room'] = $row['room'];
...
<tr>
    ...
    <p><b>Room :</b> <?php $_SESSION['room'] ?> </p>
    ...
    <td><button data-id = "<?php echo $row['id']; ?>" class="editModal123 btn btn-Primary"> Edit </button>
