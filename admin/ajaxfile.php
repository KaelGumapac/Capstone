...
<tr>
    ...
    <td><button data-id = "<?php echo $row['id']; ?>" class="updateInfo btn btn-Primary"> Edit </button>
...
<p><b>Name: </b> <?php echo $row['full_name']; ?></p>
    ...
    <p><b>Message :</b>  <?php echo $row['message']; ?></p>
    <div class="modal-footer">
    <td><button data-id = "<?php echo $row['id']; ?>" class="userinfo btn btn-Primary"> Edit </button>
    <button type="button" class="btn btn-default" data-bs-dismiss="modal">Close</button>
