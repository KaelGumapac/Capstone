  ...
  <?php  
        ...
        {  
              ...
              <tr>  
                  ...
                  <a href="reserved_delete.php?del='.$row['guest_id'].'"><button type="button" class=" btn btn-danger"><i class="fa fa-trash-o" style="font-size:15px"></i></button></a>
                  <a href="reserved_confirm.php?confirm='.$row['guest_id'].'"><button type="button" class=" btn btn-success"><i class="fa fa-check" style="font-size:15px"></i></button></a>
              </tr>  
...
<script type='text/javascript'>
        ...
        <script type='text/javascript'>
            $(document).ready(function(){
                  $("body").on('click', '.assigned_reserved', function (e){
                    var userid = $(this).data('id');
                    $.ajax({
                        url: 'reserved_confirm.php',
                        type: 'post',
                        data: {userid: userid},
                        success: function(response){ 
                            $('.modal-body').html(response); 
