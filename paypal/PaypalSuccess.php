...
$fullname = "$name" . " $last_name";
    ...
    $sample = mysqli_query($db_conn, $sql);
...
$payments2 = mysqli_query($db_conn, $payments);
                    ...
                    <div class="invoice-wrapper">
                        ...
                        <div class="customer-info">
                            ...
                            <table style="width: 100%;">
                                ...
                                <td style="width: 100px;">:&ensp;<?php echo $transaction_id; ?></td>
                                <td style="width: 120px;">TOTAL AMOUNT</td>
                                <td style="width: 70px;">: ₱&ensp;<?php echo $amount; ?></td>
                                </tr>
                                <tr>
                                <td style="width: 140px;">Email</td>
                                <td style="width: 150px;">:&ensp;<?php echo $email;?></td>
                                <td style="width: 120px;">METHOD</td>
                                <td style="width: 100px;">:&ensp;Paypal/CreditCards</td>
