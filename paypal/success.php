...
$calculated = $_SESSION['calculated'];
$room = $_SESSION['room'];
$pax = $_SESSION['pax'];
$rightamount = $_SESSION['rightamount'];
$quantity = $_SESSION['quantity'];
$total = $_SESSION['rightamount'] * $_SESSION['calculated'];
...
else
{
    ...
    $sql = "INSERT into booking (guest_id, name, invoice_id, transaction_id, email, phone, kasama, room, status, check_in, check_out, pick_up, message) 
                  VALUES ('$guest_id' ,'$name', '$invoice_id', '$transaction_id',  '$email', '$phone', '$kasama' , '$room', '$status', '$check_in', '$check_out', '$pick_up', '$message' )";
...
$mail ->Body =  'Good Day! <br> Welcome to 24/7 Balikbayan Fun Resort  ' .$name.   '<br>You have succesfully booked! Make sure to come at appointed time at ' .$pick_up. '<br> Please enjoy your staying at 24/7 Balikbayan <br> Godbless!!';
                    ...
                    <div class="invoice-wrapper">
                        ...
                        <div class="customer-info">
                            ...
                            <table style="width: 100%;">
                                ...
                                <td style="width: 70px;">: ₱&ensp;<?php echo $balance;?></td>
                                </tr>
                                </tbody>
                                </table>
                        </div>
